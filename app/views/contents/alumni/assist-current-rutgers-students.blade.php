                ...
                <div class="row section-x">
                    ...
                    <div class="list-group auto">
                            ...
                            <a href="#" class="list-group-item">
                              <i class="fa fa-chevron-right icon-muted"></i> Assist Current Rutgers Students
                            </a>


                            <a href="#" class="list-group-item">
                              <i class="fa fa-chevron-right icon-muted"></i> Job Search Strategies
                            </a>

                            <a href="#" class="list-group-item">
                              <i class="fa fa-chevron-right icon-muted"></i> Career Services for Alumni
                            </a>

                            <a href="#" class="list-group-item">
                              <i class="fa fa-chevron-right icon-muted"></i> Additional Education & Training
                            </a>

                            <a href="#" class="list-group-item">
                              <i class="fa fa-chevron-right icon-muted"></i> Self-Assessment
                            </a>
                            <a href="#" class="list-group-item">
                              <i class="fa fa-chevron-right icon-muted"></i> Career & Industry Research
                            </a>
            ...
            <div class="col-xs-8" >
                <section class="panel panel-default">
                    <div class="panel-body">
                        <h1>Assist Current Rutgers Students</h1>
                        <p>Our alumni have many ways in which to engage Rutgers students in internship and employment recruiting initiatives, partner with University Career Services to build your presence on campus, and even serve as a career mentor.</p>
                        <p><b>Getting Started with Recruiting</b></p>
                            <ul>
                                <li>In order to ensure the best experience for both students and employers, the Rutgers-New Brunswick University Career Services has instituted the following policies:</li>
