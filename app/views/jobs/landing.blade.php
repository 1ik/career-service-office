...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{URL::to('assets/css/landing-pages/jobs.css')}}"/>
  ...
  <div class="container-full-width section-a">
    ...
    <div class="slide-show-container">
      <div class="slides">
        ...
        <div class="slide">
          <img class="animated fadeInUp" src="{{URL::to('/assets/images/jobs.jpg');}}" alt="">
          <div class="slide-content">
                <div class="col-xs-12 col-md-7 heading">
        ...
        <div class="row">
            <div class="col-xs-4">
                <div class="row section-x">
                    <div class="row">
                        <div class="col-xs-3 section" style="text-align: center;">
                            <i class="flaticon-directional8" style="font-size: 6em; color:black"></i>
                        </div>
                        <div class="col-xs-9">
                            <h2 style="font-size: 3em; text-align: left; padding:.2em; margin:0px;">{{$page->sections[0]->title}}</h2>
                            <p style="margin:10px; font-size: 1em;">{{$page->sections[0]->summery}}</p>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-xs-3 section" style="text-align: center;">
                            <i class="flaticon-job3" style="font-size: 6em; color:black"></i>
                        </div>
                        <div class="col-xs-9">
                            <h2 style="font-size: 3em; text-align: left; padding:.2em; margin:0px;">{{$page->sections[1]->title}}</h2>
                            <p style="margin:10px; font-size: 1em;">{{$page->sections[1]->summery}}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                            <h2 style="font-size: 3em; text-align: left; padding:.2em; margin:0px;">{{$page->sections[2]->title}}</h2>
                            <p style="margin:10px; font-size: 1em;">{{$page->sections[2]->summery}}</p>
                        </div>
                    </div>
            ...
            <div class="col-xs-8" >
                <h2 style="text-align:left; font-size: 4em; width:80%;padding-top:0px; padding-left:10px; font-family:'Oswald', sans-serif">
                    {{$page->body_title}}
                </h2>
                <p style="font-weight: 800; font-family:'Oswald', sans-serif; text-transform: uppercase; letter-spacing: 4px; text-align: center">HOT JOBS OF THIS WEEK</p>
                  <div id="owl-demo">
                    <div class="item"><img src="http://placehold.it/120x140" alt="Owl Image"></div>
                    <div class="item"><img src="http://placehold.it/120x140" alt="Owl Image"></div>
                    <div class="item"><img src="http://placehold.it/120x140" alt="Owl Image"></div>
                    <div class="item"><img src="http://placehold.it/120x140" alt="Owl Image"></div>
                    <div class="item"><img src="http://placehold.it/120x140" alt="Owl Image"></div>
                ...
                <p style="font-weight: 800; font-family:'Oswald', sans-serif; text-transform: uppercase; letter-spacing: 4px; text-align: center">
                    <a href="{{URL::to("/sign-in")}}">Sign in </a> To See them all
                </p>
            </div>
        </div>
    </div>
