                        ...
                        @foreach($relateds as $related)
                          <li class="list-group-item">
                                <header class="panel-heading bg-white">
                                  <a href="{{URL::route('news_update.show', $related->slug)}}">{{$related->title}}</a>
                                </header>
                                <div class="panel-body">
                                  <div>{{$related->summery}}</div>
                                  <div class="comment-action m-t-sm">
                                    <a href="#comment-form" class="btn btn-default btn-xs">
                                      <i class="fa fa-inbox text-muted"></i> Read
                                    </a>
                                  </div>
                                </div>
            ...
            <div class="col-xs-8" >
                <section class="panel panel-default">
                    <div class="panel-body">
                        @if($content->image)
                        <div class="col-xs-12">
                            <img class="img img-responsive thumbnail" src="{{URL::to('files/news-updates/images/' . $content->image)}}" alt=""/>
                        </div>
                        @endif
                        ...
                        <section>
                            @if($content->attachment)
                                <a class="btn btn-success" href="{{URL::to('files/news-updates/attachments/' . $content->attachment)}}">
