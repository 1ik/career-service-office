  ...
  <head>
    ...
    <style type="text/css">
      ...
      .navbar.sticky {
        ...
        .section-d p.description {
            font-size:1.4em;
            padding-bottom: 2em;
        }


        .section-d div.left-section {
            background: #788288;
        }

        .section-d div.right-section {
            background: #E3E0D1;
        }
        ...
        .carousel .carousel-inner .item h4.text-mute {
            font-size: 3em;
        }
        ...
        .cross-sections div p.title {
            font-weight: 800;
            text-transform: uppercase;
            margin-top:-20px;
        }

        .cross-sections div i {
            position:relative;
            top:-.5em;
            font-size:3em;
        }
  ...
  <div class="container-full-width section-a">
    ...
    <div class="slide-show-container">
      <div class="slides">
        ...
        <div class="slide">
          <img class="animated fadeInUp" src="{{URL::to('/assets/images/partnership.jpg');}}" alt="" width="100%">
    ...
    <div class="container-full-width section-b " style="max-width: 900px">
