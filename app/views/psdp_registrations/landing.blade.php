...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{URL::to('assets/css/landing-pages/psdp.css')}}"/>
  </head>
  <body>
  ...
  <div class="container-full-width section-a">
    ...
    <div class="slide-show-container">
      <div class="slides">
        ...
        <div class="slide">
          <img class="animated fadeInUp" src="{{URL::to('/assets/images/psdp_program.jpg');}}" alt="" width="100%">
        ...
        $(window).scroll(function(){
            if($(window).scrollTop() >= winHeight) {
                ...
                if($('.navbar.sticky').hasClass('animated')) {
                    $(".navbar.sticky").removeClass('fadeInUp').addClass('fadeOutDown');
                }
            }
        });
    });
