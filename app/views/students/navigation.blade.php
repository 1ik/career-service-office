...
<nav class="nav-primary hidden-xs">
  ...
  <ul class="nav nav-main" data-ride="collapse">
    <li  class="@if(!isset($jobs)) {{'active'}} @endif">
      <a href="{{URL::route('student.profile', Sentry::getUser()->id)}}" class="auto">
    ...
    <li  class="@if(isset($jobs)) {{''}} @endif">
      <a href="{{URL::route('users.applications', Sentry::getUser()->id );}}" class="auto">
        <i class="fa fa-inbox icon">
        </i>
        <span class="font-bold">My Applications</span>
      </a>
    </li>
  </ul>
</div>
